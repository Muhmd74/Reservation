...
{
    public class DeleteOrRestoreHandler : IRequestHandler<DeleteOrRestoreCommand, OutputResponse<bool>>
    {
        private readonly ApplicationDbContext _context;

        public DeleteOrRestoreHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<OutputResponse<bool>> Handle(DeleteOrRestoreCommand request, CancellationToken cancellationToken)
        {
